...
import copy
## cshetty2: imports changed
import tensorflow as tf

slim = tf.contrib.slim

from tensorflow.contrib import training as contrib_training
from image_classifier.networks import nasnet_utils
...
def build_nasnet_cifar(images, num_classes,
                       is_training=True,
                       config=None,
                       current_step=None, data_format=None): ## cshetty2: Added dummy 'data_format' to keep consistent with iception and cifarnet
